...
from utils_con import build_data, build_vocab, convert, convert_CSC, load_vocab
...
def main():
    ...
    parser.add_argument("--glv_word_ids", type=str, default=None)
    parser.add_argument("--glv_id_vec", type=str, default=None)
...
#    chainer.global_config.autotune=True
    ...
    if params.glove:
        if params.glv_id_vec and params.glv_word_ids:
            ...
            with open('/home/tsuyuki/data/GloVe2/glv_id_vec.pkl','wb') as f:
                pickle.dump(id_vec, f)
            with open('/home/tsuyuki/data/GloVe2/glv_word_ids.pkl','wb') as f:
    ...
    #iterator
    train_iter = chainer.iterators.SerialIterator(train, params.batch_size, False, False)
    ...
    trainer = chainer.training.Trainer(updater, (1, 'epoch'), out=params.outputdir)
